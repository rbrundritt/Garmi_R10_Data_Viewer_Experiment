...
{
    public partial class CarryDistanceML
    {
        public const string RetrainFilePath =  @"C:\Users\ricky\source\repos\GarminR10DataViewer\GolfShotML\ML Data\CarryDistance-TrainingData.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"BallSpeedMPS", @"BallSpeedMPS"),new InputOutputColumnPair(@"VerticalLaunchAngleDeg", @"VerticalLaunchAngleDeg"),new InputOutputColumnPair(@"HorizontalLaunchAngleDeg", @"HorizontalLaunchAngleDeg"),new InputOutputColumnPair(@"SpinRateRPM", @"SpinRateRPM"),new InputOutputColumnPair(@"SpinAxisDeg", @"SpinAxisDeg")})      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=443,MinimumExampleCountPerLeaf=20,LearningRate=0.675344618185579,LabelColumnName=@"CarryDistanceM",FeatureColumnName=@"Features",ExampleWeightColumnName=null,Booster=new GradientBooster.Options(){SubsampleFraction=0.999999776672986,FeatureFraction=0.929847635234287,L1Regularization=2.19906905666788E-09,L2Regularization=0.370137788954642},MaximumBinCountPerFeature=325}));
