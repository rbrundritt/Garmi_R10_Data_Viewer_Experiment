...
{
    public partial class BallSpeedAtImpactML
    {
        public const string RetrainFilePath =  @"C:\Users\ricky\source\repos\GarminR10DataViewer\GolfShotML\ML Data\BallSpeedAtImpact-TrainingData.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"BallSpeedMPS", @"BallSpeedMPS"),new InputOutputColumnPair(@"VerticalLaunchAngleDeg", @"VerticalLaunchAngleDeg"),new InputOutputColumnPair(@"HorizontalLaunchAngleDeg", @"HorizontalLaunchAngleDeg"),new InputOutputColumnPair(@"SpinRateRPM", @"SpinRateRPM"),new InputOutputColumnPair(@"SpinAxisDeg", @"SpinAxisDeg")})      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=244,MinimumExampleCountPerLeaf=22,LearningRate=0.683970413536229,LabelColumnName=@"BallSpeedAtImpactMPS",FeatureColumnName=@"Features",ExampleWeightColumnName=null,Booster=new GradientBooster.Options(){SubsampleFraction=0.999999776672986,FeatureFraction=0.985376973358481,L1Regularization=2E-10,L2Regularization=0.083029641354869},MaximumBinCountPerFeature=256}));
