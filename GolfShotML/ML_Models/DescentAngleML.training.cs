...
{
    public partial class DescentAngleML
    {
        public const string RetrainFilePath =  @"C:\Users\ricky\source\repos\GarminR10DataViewer\GolfShotML\ML Data\DescentAngle-TrainingData.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"BallSpeedMPS", @"BallSpeedMPS"),new InputOutputColumnPair(@"VerticalLaunchAngleDeg", @"VerticalLaunchAngleDeg"),new InputOutputColumnPair(@"HorizontalLaunchAngleDeg", @"HorizontalLaunchAngleDeg"),new InputOutputColumnPair(@"SpinRateRPM", @"SpinRateRPM"),new InputOutputColumnPair(@"SpinAxisDeg", @"SpinAxisDeg")})      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=762,MinimumExampleCountPerLeaf=21,LearningRate=0.724030644402307,LabelColumnName=@"DescentAngleDeg",FeatureColumnName=@"Features",ExampleWeightColumnName=null,Booster=new GradientBooster.Options(){SubsampleFraction=0.0156631543105962,FeatureFraction=0.958856881749801,L1Regularization=3.42006644763382E-10,L2Regularization=0.632733136212656},MaximumBinCountPerFeature=273}));
